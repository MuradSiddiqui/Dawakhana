  ...
  ur: {
    ...
    about: {
      ...
      founder: {
        ...
        history: 'حکیم مخدوم محمد مراد صدیقی (1925 میں پیدا ہوئے، سہون شریف) نے دار الشفا مفید عام دواخانہ کلینکس کی بنیاد رکھی۔ انگریزی، فارسی، اردو، سندھی، بلوچی، اور پنجابی میں روانی کے ساتھ، انہوں نے اپنی زندگی تعلیم اور خدمت کے لیے وقف کر دی۔ انہوں نے سہون شریف میں یونانی طب اور تعلیم پر کاموں کے ساتھ ایک عوامی لائبریری قائم کی، اور وسیع بیماریوں کے علاج کے لیے جانے جانے والے ایک معزز جنرل فزیشن تھے۔'
      }
    },
